...
window.onload = valordaspaginas;

function valordaspaginas(){
    var valordophp;
    valordophp = document.getElementById('valorphp').innerHTML;
    document.getElementById('valorhtml').innerHTML = valordophp;
}
